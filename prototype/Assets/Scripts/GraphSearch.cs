...
public class GraphSearch
{
    ...
    {
        Dictionary<Vector3Int, Vector3Int?> visitiedNodes = new Dictionary<Vector3Int, Vector3Int?> ();
        ...
        visitiedNodes.Add(startPoint, null);
        ...
        while (nodesToVisitQueue.Count > 0)
        {
            ...
            foreach (Vector3Int neighbourPosition in hexGrid.GetNeighboursFor(currentNode))
            {
                ...
                {
                    if (!visitiedNodes.ContainsKey(neighbourPosition))
                    {
                        visitiedNodes[neighbourPosition] = currentNode;
        ...
        return new BFSResult { visitedNodesDict = visitiedNodes };
